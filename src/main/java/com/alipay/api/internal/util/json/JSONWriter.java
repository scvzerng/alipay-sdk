...
//    }
    ...
    public static String write(Object object, SerializerFeature... feature) {
...
//            value(Array.get(object, i),null, isApiModel);
//            if (i < length - 1)
//                add(',');
//        }
//        add("]");
