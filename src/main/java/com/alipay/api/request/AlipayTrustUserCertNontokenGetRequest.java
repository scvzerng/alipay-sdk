...
import com.alipay.api.response.AlipayTrustUserCertNontokenGetResponse;
 ...
 */
public class AlipayTrustUserCertNontokenGetRequest implements AlipayRequest<AlipayTrustUserCertNontokenGetResponse> {
	...
	* 入参json串，用于定位用户身份
	...
	public Class<AlipayTrustUserCertNontokenGetResponse> getResponseClass() {
		return AlipayTrustUserCertNontokenGetResponse.class;
	}
