...
import com.alipay.api.response.AlipayAcquireCreateResponse;
 ...
 * 
 * @author auto create
 * @since 1.0, 2015-04-02 14:25:53
 */
public class AlipayAcquireCreateRequest implements AlipayRequest<AlipayAcquireCreateResponse> {
...
该参数最长为128个汉字
	...
	* 订单金额。该笔订单的资金总额，取值范围[0.01,100000000]，精确到小数点后2位。
	...
	public Class<AlipayAcquireCreateResponse> getResponseClass() {
		return AlipayAcquireCreateResponse.class;
	}
