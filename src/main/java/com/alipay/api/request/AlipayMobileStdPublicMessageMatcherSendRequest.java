...
import com.alipay.api.response.AlipayMobileStdPublicMessageMatcherSendResponse;
	...
	* 业务内容json，其中包括匹配器matcher和模板template两大块，注意这里的userId仅接受2088开头，样例如下
{
	...
	public Class<AlipayMobileStdPublicMessageMatcherSendResponse> getResponseClass() {
		return AlipayMobileStdPublicMessageMatcherSendResponse.class;
	}
