...
public class KoubeiAdvertCommissionAdvertPurchaseModel extends AlipayObject {
     ...
     */
    @JSONField(name = "out_unique_id", alternateNames = "outUniqueId")
     ...
     */
    @JSONField(name = "security_code", alternateNames = "securityCode")
     ...
     */
    @JSONField(name = "trigger_identifies", alternateNames = "triggerIdentifies")
     ...
     * advert-广告ID
     */
    @JSONField(name = "trigger_identify_type", alternateNames = "triggerIdentifyType")
     ...
     */
    @JSONField(name = "user_identify", alternateNames = "userIdentify")
     ...
     * user_id - 支付宝账户ID
     */
    @JSONField(name = "user_identify_type", alternateNames = "userIdentifyType")
