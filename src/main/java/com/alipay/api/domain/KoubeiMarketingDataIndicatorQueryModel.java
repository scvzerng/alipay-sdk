...
public class KoubeiMarketingDataIndicatorQueryModel extends AlipayObject {
    ...
    public enum BizType {
        MemberQuery(MemberQueryModel.class),
        MemberQueryByStore(MemberQueryByStoreModel.class),
        TradeQuery(TradeQueryModel.class),
        TradeQueryByStore(TradeQueryByStoreModel.class),
        CampaignQuery(CampaignQueryModel.class),
        CampaignQueryByStore(CampaignQueryByStoreModel.class);
