...
/**
 * ALIPAY API: alipay.commerce.transport.offlinepay.auth.key.query response.
 * 
 * @author auto create
 * @since 1.0, 2016-07-11 15:05:20
 */
public class AlipayCommerceTransportOfflinepayAuthKeyQueryResponse extends AlipayResponse {

	private static final long serialVersionUID = 6251457435129626621L;
