 ...
 * 
 * @author auto create
 * @since 1.0, 2016-06-02 13:14:30
 */
public class AlipayUserUserinfoShareResponse extends AlipayResponse {

	private static final long serialVersionUID = 5549648889234126988L;
...
10其它证件
	 ...
	 */
	@ApiField("masked_logon_id")
	private String maskedLogonId;
...
1代表公司账户2代表个人账户
	...
	public void setMaskedLogonId(String maskedLogonId) {
		this.maskedLogonId = maskedLogonId;
	}
	public String getMaskedLogonId( ) {
		return this.maskedLogonId;
	}
