...
//        return execute(request,features);
//    }
//
//    /**
...
//
//        return execute(request, accessToken,features);
//    }
//
//
...
//
//        return _execute(request, accessToken, appAuthToken,features);
//    }
//
//    private <T extends AlipayResponse> T _execute(AlipayRequest<T> request, String authToken,
//                                                  String appAuthToken,SerializerFeature... features) throws AlipayApiException {
//
//        return doGet(request, appAuthToken,features);
//    }
//
